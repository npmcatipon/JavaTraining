	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				studentService.addStudent(name, Integer.parseInt(age), email);
			...
			case 2:
				...
				if (!courseService.isValid(studentId)) {
					System.out.printf("Student ID %d is not existing.%n", studentId);
					break;
				}
				...
				courseService.addCourse(studentId, courseName, Integer.parseInt(grade));
				System.out.printf("Student ID: %d, Course Name: %s, Grade: %d. Added successfully.%n", studentId,
						courseName, grade);
				break;
			...
			case 4:
				System.out.println("\nID | Student ID | Course Name | Grade | Name");
				System.out.println("--------------------------------------------");
				for (Courses c : courseService.getCourse()) {
					System.out.printf("%d | %d | %s | %d | %s%n", c.getId(), c.getStudent_id(), c.getCourse_name(),
							c.getGrade(), c.getName());
				}
				break;
